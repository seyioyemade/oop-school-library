...
```sh
   git clone https://github.com/seyioyemade/oop-school-library.git
```
...
Feel free to check the [issues page](https://github.com/seyioyemade/oop-school-library/issues).
<p align="right">(<a href="#readme-top">back to top</a>)</p>
<!-- SUPPORT -->
